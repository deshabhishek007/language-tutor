...
/**
 * Title: Blog Section
 * Slug: language-tutor/blog-section
 * Categories: language-tutor, blog-section
 *
 * PHP version 7.4
 *
 ...
 */
?>
<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"30px","bottom":"0px"},"margin":{"top":"0px","bottom":"0px"}}},"backgroundColor":"custom-secondary","layout":{"type":"constrained"}} -->
<main id="blog" class="wp-block-group has-custom-secondary-background-color has-background" style="margin-top:0px;margin-bottom:0px;padding-top:30px;padding-bottom:0px"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"40px","letterSpacing":"-2px"},"elements":{"link":{"color":{"text":"var:preset|color|custom-black"}}}},"textColor":"custom-black","fontFamily":"dm-sans"} -->
...
<!-- wp:post-date {"style":{"typography":{"fontSize":"15px"},"elements":{"link":{"color":{"text":"var:preset|color|custom-text"}}}},"textColor":"custom-text","fontFamily":"dm-sans"} /-->

<!-- wp:post-title {"style":{"typography":{"fontSize":"20px","textDecoration":"none"}},"fontFamily":"dm-sans"} /-->

<!-- wp:post-excerpt {"style":{"typography":{"fontSize":"16px"},"elements":{"link":{"color":{"text":"var:preset|color|custom-text"}}}},"textColor":"custom-text","fontFamily":"dm-sans"} /--></main>
<!-- /wp:group -->
